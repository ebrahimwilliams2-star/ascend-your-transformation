...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <nav
        className="pointer-events-none fixed bottom-0 left-1/2 z-nav -translate-x-1/2 w-full max-w-md px-4 pt-2"
        style={{ paddingBottom: "calc(1rem + env(safe-area-inset-bottom))" }}
      >
        <div className="pointer-events-auto relative grid grid-cols-5 items-center rounded-2xl border border-white/10 bg-brand-black/95 px-2 py-3 backdrop-blur-xl">
